...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="min-h-screen w-full bg-stone-900 flex justify-center overflow-hidden relative font-sans text-stone-100">
       ...
       {/* Mobile Container */}
       <div className="w-full max-w-md h-[100dvh] relative z-10 bg-[#FAFAF7]/5 backdrop-blur-md shadow-2xl flex flex-col overflow-hidden border-x border-white/10 sm:rounded-3xl sm:my-4 sm:h-[calc(100vh-2rem)]">
          {children}
       </div>
    </div>
  );
